<template>
    <el-main>
        <el-form ref="form" :model="form" style="text-align: left;height: 100px;line-height: 100px;">
            <el-form-item label="锁id" label-width="40px">
                <el-input v-model="form.lockId"></el-input>
            </el-form-item>
            <el-form-item label="用户id" label-width="60px">
                <el-input v-model="form.userId"></el-input>
            </el-form-item>
            <el-form-item label="开锁方式" label-width="90px">
            ...
            <el-form-item label="开锁结果" label-width="90px">
        ...
        <el-table :data="tableData"  style="width: 94%;margin: 1.625rem auto" border>
            <el-table-column
                prop="lockId"
                label="锁id">
            </el-table-column>
